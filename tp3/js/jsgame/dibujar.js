...
function init(dificultad, nombre1, ficha1, nombre2, ficha2){
    ...
    imagenFicha1.src = "img/fichas/Mcarne.jpg";
    
    let imagenFicha2 = new Image();
    imagenFicha2.src = "img/fichas/Mpollo.jpg";

    let imagenFicha3 = new Image();
    imagenFicha3.src = "img/fichas/mila-simple.jpg";

    let imagenFicha4 = new Image();
    imagenFicha4.src = "img/fichas/mila_completa.jpg";

    let imagenFicha5 = new Image();
    imagenFicha5.src = "img/fichas/milanesa-a-la-napolitana.jpg";

    let imagenFicha6 = new Image();
    imagenFicha6.src = "img/fichas/Milanesa-de-pescado-al-horno.jpg";
